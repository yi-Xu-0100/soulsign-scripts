...
exports.run = async function (param) {
  ...
  var { data } = await axios.post('https://api.wfdata.club/v1/attendance/userSignIn', null, {
    headers: {
      Origin: 'https://www.feng.com',
      Referer: 'https://www.feng.com/',
      'X-Access-Token':
