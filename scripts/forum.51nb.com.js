...
/**
 * @module 51NB论坛签到脚本
 * @description 本脚本借鉴 [hithy123 的人大经济论坛签到脚本](https://soulsign.inu1255.cn/scripts/225)，更改了检查在线逻辑。
 * 
...
exports.run = async function (param) {
    var signurl = "https://forum.51nb.com/plugin.php?id=dsu_paulsign:sign";
...
exports.check = async function (param) {
    var { data } = await axios.get('https://forum.51nb.com/home.php?mod=spacecp');
