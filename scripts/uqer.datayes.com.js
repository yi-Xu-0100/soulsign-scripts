...
exports.run = async function (param) {
    ...
    var resp2 = await axios.get(`https://gw.datayes.com/mercury_community/user/${user_id}?field=point_stats`);
    var originPoints = resp2.data.data.point_stats.available_points;
    var resp3 = await axios.post('https://gw.datayes.com/mercury_community/popwindow',
    ...
    var resp4 = await axios.get(`https://gw.datayes.com/mercury_community/user/${user_id}?field=point_stats`);
