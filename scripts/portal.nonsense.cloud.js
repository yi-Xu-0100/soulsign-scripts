...
// @version           1.0.0
// @author            yi-Xu-0100
// @loginURL          https://portal.nonsense.cloud/auth/login
// @updateURL         https://soulsign.inu1255.cn/script/yi-Xu-0100/白嫖云签到
// @expire            900000
// @domain            portal.nonsense.cloud
// @param            name 账户
// @param            pwd 密码
// ==/UserScript==
 ...
 * @param {string|string[]} [domain = portal.nonsense.cloud] - 请求的域名
...
exports.run = async function (param) {
  var resp = await axios.post('https://portal.nonsense.cloud/user/checkin');
...
exports.check = async function (param) {
  var resp = await axios.get('https://portal.nonsense.cloud/user');
  if (/用户中心/.test(resp.data)) return true;
  else {
    let resp = await axios.post('https://portal.nonsense.cloud/auth/login', {
      email: param.name,
      passwd: param.pwd,
      remember_me: 'week'
    });
